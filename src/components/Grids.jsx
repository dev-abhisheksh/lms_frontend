                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-start justify-between mb-3">
                                <h2 className="text-base sm:text-base md:text-lg font-semibold text-gray-900 leading-snug group-hover:text-[#7034FF] transition-colors flex-1">
                                    {item.course.title}
                                </h2>
                            ...
                            <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                                ...
                                <svg
                                    className="w-4 h-4 text-gray-400 group-hover:text-[#7034FF] group-hover:translate-x-1 transition-all"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
